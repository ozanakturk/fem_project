...
for n in range(num_steps):
    ...
    #k_sol.x.array[:] = u_n.x.array + dt* bt_a * k_sol.x.array
...
error_max = domain.comm.allreduce(numpy.max(numpy.abs(k_sol.x.array - u_D.x.array)), op=MPI.MAX) # duD_dt
if domain.comm.rank == 0:
